...
namespace OpticApp.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(OpticAppContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,nom,prenom,dateNaissance,tel,profession,adresse,ville,mail,sexe,remarque")] Client client)
        {
            if (id != client.ID)
            {
                return NotFound();
